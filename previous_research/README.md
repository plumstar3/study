...
\:warning: このREADMEファイルは<a href="https://github.com/saeedkhaki92/CNN-RNN-Yield-Prediction" target="_blank">"先行研究のオープンソースコード"</a>
にあるREADMEファイルの内容となっています。

\:warning:sampleデータなどは一つ上のディレクトリにあるので、注意してください。
